...
// replays, with NO margin: the run that pinned it REPLAYED exactly 157
// scenarios, and 158 fails. (155 -> 157: upstream corpus growth the floor had
// drifted behind; the conformance/replay/ fixtures added in #lzreplayjs carry
// `steps`, not `scenarios`, and contribute none. 153 -> 155: the two
// lossless-tree apply_update fixtures lazily-spec 39df4b3 added carry one
// scenario each, #lzspecoutoforderfixtures.)
//
